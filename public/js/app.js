...
function initAdmin(socket) {
  // pass socket object from app.js
  // select element of table body
  var orderTableBody = document.querySelector("#orderTableBody"); //console.log(orderTableBody.innerHTML)
  // create array for all orders

  var orders = []; // create markup for table body and initially se to undefined means not initialized

  var markup; // Fetch all data from server regarding all orders using axios client ajax reqquest.
  ...
  function renderItems(items) {
    var parsedItems = Object.values(items); // return all values in an array
  ...
  socket.on('orderPlaced', function (order) {
    new (noty__WEBPACK_IMPORTED_MODULE_2___default())({
      ...
      timeout: 1000,
      progressBar: false
    }).show(); // push latest order to the orders arrays

    orders.unshift(order); // unshift() insert data at first position of array
    // then clear first orderTableBody

    orderTableBody.innerHTML = ''; // now insert fresh all orders

    orderTableBody.innerHTML = generateMarkup(orders); // pass orders array 
  });
} // ends initAdmin()
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ placedOrder)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
...
function placedOrder(formObject) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/orders", formObject).then(function (res) {
    ...
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      ...
      // display success message for 1 sec after visit orders page
      timeout: 3000,
      progressBar: false
    }).show();
    setTimeout(function () {
...
var addCart = document.querySelectorAll('.add-to-cart'); // return array
...
var statuses = document.querySelectorAll('.status_line'); // return all status list in an array
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    var dataProp = status.dataset.status; // return data-status value 
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      small.innerText = moment__WEBPACK_IMPORTED_MODULE_2___default()(order.updatedAt).format('hh:mm A');
      status.append(small);
...
socket.on('orderUpdated', function (data) {
  // orderUpdated comes from server.js file
  var updatedOrder = _objectSpread({}, order);

  updatedOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_2___default()().format();
  updatedOrder.status = data.status; // console.log(data); //display data at client console at real time without refreshing
  // call updateStatus and pass updateOrder

  updateStatus(updatedOrder); // show notification 
...
var CardWidget = /*#__PURE__*/function () {
  ...
  _createClass(CardWidget, [{
    key: "mountWidget",
    value: function mountWidget() {
      // create stripe element
      var elements = this.stripe.elements(); // create card using elements
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                console.log("Error into create a token for stripe : " + _context.t0);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ initStripe)
/* harmony export */ });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_4__.loadStripe)("pk_test_51IqEtOSFMiZcXe76MrXn2qTIhVqvUMqurMmtcKJRlTVONngFi79zsapzx77u9mzEm946OVTaGmyKVv5z3VBZijZf00Tp93456O");
          ...
          case 2:
            ...
            if (paymentType) {
              paymentType.addEventListener("change", function (e) {
                if (e.target.value === "card") {
                  // display card widget
                  card = new _cardWidget__WEBPACK_IMPORTED_MODULE_6__.CardWidget(stripe); // Initialize an object of CardWIdget and refer to card variable.
            ...
            paymentForm = document.querySelector("#payment-form"); // select /orders form by their id selector from cart.ejs
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          formData = new FormData(paymentForm); // FormData is javascript default class.
                          //console.log(formData);
                          // create an empty object

                          formObject = {}; // while iterating formData by calling entries() with forEach
                          ...
                          (0,_apiService__WEBPACK_IMPORTED_MODULE_5__.default)(formObject);
                        ...
                        case 10:
                          token = _context.sent;
                          // must use await becoz we createToken() in CardWidget class use await and always return promise.
                          // console.log(token)
